...
-- Users table - stores VT student information (Auth handled by Firebase)
CREATE TABLE users (
...
-- Categories table - listing categories
...
-- Listings table - items and services for sale
...
-- Service-specific details (for tutoring, etc.)
